...
const data_projects = [
    ...
    },
    {
        ...
        deployed_url: 'https://bhanuprathap2000.github.io/Quote-Generator/',
        github_url: 'https://github.com/bhanuprathap2000/Quote-Generator',
        category: ['vanilla']
    },
    {
        name: 'Infinite Image Scroll',
        image: infiniteScroll,
        deployed_url: 'https://infinite-image-scroll.netlify.app/',
        github_url: 'https://github.com/bhanuprathap2000/infinite-image-scroll',
        category: ['vanilla']
    },
    {
        name: 'Student Registartion',
        image: studentRegistration,
        deployed_url: 'https://github.com/bhanuprathap2000/student-registration',
        github_url: 'https://github.com/bhanuprathap2000/student-registration',
        category: ['python']
    },
